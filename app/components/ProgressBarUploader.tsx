...
export const ProgressBarUploader: React.FC<ProgressBarUploaderProps> = ({
  ...
  return (
    ...
    <div className="min-w-full bg-purple-500 rounded-lg shadow-2xl p-5 border">
        ...
        {selectedFile && (
          <>
            <div className="flex flex-row justify-between">
              <div
                key="1"
                className="flex items-center mb-2 text-blue-700"
              >
            ...
            >
              <div
                className="h-6 bg-blue-700 rounded-full"
